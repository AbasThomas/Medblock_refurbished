                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-gray-300 mb-6 max-w-md leading-relaxed">
                            Nigeria's pioneering secure data platform for providers. Empowering safer collaboration across hospitals and labs.
                        </p>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        <div className="text-gray-400 text-sm text-center md:text-left">
                            <p>
                                Unified digital records for patients, providers, HMOs, and public health teams.
                            </p>
                        </div>

                        <div className="flex items-center space-x-6 text-sm text-gray-400">
                            <span>Copyright {currentYear} MEDBLOCK. All rights reserved.</span>
